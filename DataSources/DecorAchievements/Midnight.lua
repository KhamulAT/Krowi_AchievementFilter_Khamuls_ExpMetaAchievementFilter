...
function GetHousingMN()
    ...
    local ACMChilds_OmniumFolioStudies = {
        Utilities:GetAchievementName(63325),
        false,
        {
    ...
    if KhamulsAchievementFilter.db.profile.decorAchievementsSettings.includeChildAchievements then
        ACMListFlat[#ACMListFlat+1] = ACMChilds_OmniumFolioStudies
    end
    ...
    if KhamulsAchievementFilter.db.profile.decorAchievementsSettings.includeChildAchievements then
        ACMList_VoidAssaults[#ACMList_VoidAssaults+1] = ACMChilds_OmniumFolioStudies
    end
